...
int main(int argc, char *argv[])
{
    ...
    // пример близкого наложения прямоугольников
    ImageItem item1(QSize(24, 50)); // 24, 50
    ImageItem item2(QSize(30, 30)); //26 //30, 30
    ImageItem item3(QSize(25, 50));
    ImageItem item4(QSize(27, 70));
    ImageItem item5(QSize(23, 40)); //40
    ImageItem item6(QSize(21, 45)); //25, 45
    ImageItem item7(QSize(22, 50)); //25, 50
    ImageItem item8(QSize(28, 50));
    ImageItem item9(QSize(25, 110)); //,110
    ImageItem item10(QSize(20, 80)); //25
    ...
    mycontainer.setContainerSize(QSize(95, 400)); //95
